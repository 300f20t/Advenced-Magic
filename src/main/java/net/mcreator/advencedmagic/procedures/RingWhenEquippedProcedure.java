...
public class RingWhenEquippedProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof LivingEntity lv ? CuriosApi.getCuriosHelper().findEquippedCurio(AdvencedMagicModItems.GOLDEN_RING.get(), lv).isPresent() : false) {
			{
