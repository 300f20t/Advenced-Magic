...
public class ModifierChangeInSlot2Procedure {
	public static void execute(Entity entity) {
		...
		old_modifier = new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation(((item.getOrCreateTag().getString("modifier_2"))).toLowerCase(java.util.Locale.ENGLISH))));
		item.getOrCreateTag().putString("modifier_2", (BuiltInRegistries.ITEM.getKey(modifier.getItem()).toString()));
