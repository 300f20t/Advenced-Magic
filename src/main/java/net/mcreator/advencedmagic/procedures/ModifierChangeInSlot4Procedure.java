...
public class ModifierChangeInSlot4Procedure {
	public static void execute(Entity entity) {
		...
		old_modifier = new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation(((item.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getString("modifier_4"))).toLowerCase(java.util.Locale.ENGLISH))));
		{
			final String _tagName = "modifier_4";
