...
public class ModifierChangeInSlot3Procedure {
	public static void execute(Entity entity) {
		...
		old_modifier = new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation(((item.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getString("modifier_3"))).toLowerCase(java.util.Locale.ENGLISH))));
		{
			final String _tagName = "modifier_3";
