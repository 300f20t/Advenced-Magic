...
import net.mcreator.advencedmagic.world.inventory.Note1Menu;
...
public class AdvencedMagicModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<Note1Menu>> NOTE_1 = REGISTRY.register("note_1", () -> IMenuTypeExtension.create(Note1Menu::new));
}
