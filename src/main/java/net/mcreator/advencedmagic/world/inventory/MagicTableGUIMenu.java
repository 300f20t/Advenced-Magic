...
public class MagicTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MagicTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AdvencedMagicModMenus.MAGIC_TABLE_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 61, 35) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PacketDistributor.SERVER.noArg().send(new MagicTableGUISlotMessage(slotid, x, y, z, ctype, meta));
